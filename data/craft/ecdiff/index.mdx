...
Beautifies an Eclipse IDE and CVS unified diff code patch on the browser. The new version of previously known as [Eclipse Patch Viewer](/craft/eclipse-patch-viewer) bookmarklet.
