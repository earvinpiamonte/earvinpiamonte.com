...
There are three things I set up for this project:
...
I was looking to publish this Applet on IFTTT but unfortunately, IFTTT doesn't allow publishing an Applet with Webhooks. More info [here](https://help.ifttt.com/hc/en-us/articles/115010230347-Webhooks-service-FAQ).

Because I can't share the Applet on IFTTT, I built a small website where interested users can subscribe to get scheduled power interruptions in Baguio City. Built with Next.js, Prisma and PlanetScale and will be deployed on Vercel. Here's a teaser.

<Thumbnail
  src="/images/post/apologize/Screenshot from 2022-04-21 03-11-39.jpg"
  alt="Screenshot of BENECO Scheduled Interruptions web page"
/>
