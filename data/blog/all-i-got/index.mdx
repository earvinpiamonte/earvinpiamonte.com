...
It works by calling a serverless function on Vercel that captures a screenshot of the page that contains the data I need for the thumbnail. This feature is also what implemented on [nbi.vercel.app](/craft/nbi.vercel.app).
