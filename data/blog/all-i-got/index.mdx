...
I first tried using Next.js last year by building [drownthesky](https://www.earvinpiamonte.com/craft/drownthesky). Not long after, I fell in love with the development experience so I built another Next.js site, [nbi.vercel.app](https://www.earvinpiamonte.com/craft/nbi.vercel.app).
...
One cool feature of my site is that it generates the social preview thumbnail for each page on demand. It means that the thumbnail is not stored or available anywhere until the link of the page is shared on other platforms such as Twitter.

It works by calling a serverless function on Vercel that captures a screenshot of the page that contains the data I need for the thumbnail. This feature is also what implemented on [nbi.vercel.app](https://www.earvinpiamonte.com/craft/nbi.vercel.app).
