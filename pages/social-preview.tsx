    ...
    >
      <div className="grid grid-cols-12 gap-4">
        ...
        <div className="col-span-4">
          <div className="p-4 bg-gradient-to-r from-green-400 via-indigo-500 to-purple-500 rounded-xl transform rotate-3">
            <Image
              ...
              quality={50}
            />
            <PencilIcon className="w-16 h-16 absolute -left-5 -bottom-5 text-white bg-purple-500 rounded-full p-2 border-4 border-green-500" />
          </div>
        </div>
      </div>
    </div>
